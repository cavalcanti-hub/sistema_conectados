...
CREATE TABLE `mercado_pago_point_orders` (
  ...
  `payload` mediumtext DEFAULT NULL,
  `installments_requested` int(11) DEFAULT NULL,
  `installments_confirmed` int(11) DEFAULT NULL,
  `installments_cost` varchar(20) DEFAULT NULL,
  `customer_total_paid` decimal(10,2) DEFAULT NULL,
  `customer_financing_cost` decimal(10,2) DEFAULT NULL,
  `seller_processing_fee` decimal(10,2) DEFAULT NULL,
  `seller_financing_cost` decimal(10,2) DEFAULT NULL,
  `seller_total_fee` decimal(10,2) DEFAULT NULL,
  `seller_net_received` decimal(10,2) DEFAULT NULL,
  `values_source` enum('estimated','confirmed') DEFAULT 'estimated',
  `reconciliation_status` varchar(40) DEFAULT NULL,
