    ...
    private function seedPhoneModels(): void
    {
        $modelsByBrand = [
            ...
            'Samsung' => [
                ...
                'Galaxy S25 Plus', 'Galaxy S25 Ultra', 'Galaxy Note 9', 'Galaxy Note 10',
                'Galaxy Note 10 Plus', 'Galaxy Note 20', 'Galaxy Note 20 Ultra',
            ...
            'Motorola' => [
                ...
                'Moto E6s', 'Moto E7', 'Moto E7 Plus', 'Moto E7 Power', 'Moto E13',
                'Moto E14', 'Moto E20', 'Moto E22', 'Moto E22i', 'Moto E30', 'Moto E32',
                'Moto E32s', 'Moto E40', 'Moto G5', 'Moto G5 Plus', 'Moto G5s',
                ...
                'Moto G200', 'Motorola Edge 20', 'Motorola Edge 20 Lite',
                ...
                'Motorola Edge 50 Pro', 'Motorola Edge 50 Ultra', 'Motorola Razr 40',
                'Motorola Razr 40 Ultra', 'Motorola Razr 50', 'Motorola Razr 50 Ultra',
            ],
            'Xiaomi' => [
                'Redmi 8', 'Redmi 8A', 'Redmi 9', 'Redmi 9A', 'Redmi 9C', 'Redmi 9T',
                ...
                'Redmi Note 14 Pro 5G', 'Redmi Note 14 Pro Plus 5G', 'Poco C40',
                'Poco C65', 'Poco C75', 'Poco F3', 'Poco F4', 'Poco F5',
                'Poco F5 Pro', 'Poco F6', 'Poco F6 Pro', 'Poco M3', 'Poco M4 Pro',
                'Poco M4 Pro 5G', 'Poco M5', 'Poco M5s', 'Poco M6 Pro', 'Poco X3',
                'Poco X3 Pro', 'Poco X4 Pro', 'Poco X5', 'Poco X5 Pro',
                'Poco X6', 'Poco X6 Pro', 'Poco X7', 'Poco X7 Pro', 'Mi 8',
                'Mi 9', 'Mi 9T', 'Mi 9T Pro', 'Mi 10', 'Mi 10T', 'Mi 10T Pro',
